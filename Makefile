...
SRCS_CXX=audio.cxx autoplay.cxx compile.cxx curl.cxx dvdnav.cxx fs.cxx generator.cxx language.cxx lcd.cxx network.cxx packages.cxx recorder.cxx remote.cxx theme.cxx system.cxx video.cxx
