...
SRCS_CXX=audio.cxx autoplay.cxx compile.cxx curl.cxx dvdnav.cxx fs.cxx generator.cxx keymap.cxx language.cxx lcd.cxx ndiswrapper.cxx network.cxx nfs.cxx packages.cxx remote.cxx theme.cxx system.cxx video.cxx
